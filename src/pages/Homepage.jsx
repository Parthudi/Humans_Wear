...
const HomePage = React.memo(() => {
    ...
    return(
        <Container mt={10} style={{minHeight: '80vh'}}>
            <ShowCarousel />
            <Box mt={15} />
            <Directory />
            ...
            <div style={{textAlign:"center", padding:"0% 20%"}} data-aos="zoom-in-up">
                ...
                <p>The Humans Wear has one of the finest and best clothing application with all genuine and ultra classy brands which advances the way people live and look. What sets us apart? Our easy to understand UI, easy to return and exchange products, all branded products are available with least prices.</p>
                ...
                <Box mt={5}/>
                <h2 style={{color:"darkgrey"}}> <b> Follow The Humans Wear </b></h2>
            </div>
        </Container>
    )
})
